 ...
 class cls_lurd_control extends cls_lurd
 {
    ...
    */
    public function e_list(&$request_array)
    {
        ...
        $this->list_datas();
        $this->assign('lurd_pagination', $this->get_pagination($url, 'ylmf-page', $this->show_total_infos));
    ...
    */
    public function e_saveadd(&$request_array)
    {
        ...
        {
            cls_msgbox::show('系统提示', '成功增加一条记录！', $this->end_back_url);
            exit();
        }
    }
    ...
    */
    public function e_saveedit(&$request_array)
    {
        ...
        if( !$this->end_need_done )
        {
            cls_msgbox::show('系统提示', '成功修改一条记录！', $this->end_back_url);
            exit();
        }
    }
